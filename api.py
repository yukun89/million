...
def create_order(symbol, amout, buy_sell, price = 0):
    symbol = symbol+"usdt"
    if buy_sell == "buy":
        buy = 1
    elif buy_sell == "sell":
        ...
        log_error("invalid parameter for buy_sell %s" % buy_sell)
        return
    """
...
def get_raw_price_data():
    ...
    for currency_type in currency_types:
        ...
        print(get_current_kline(currency_type, "usdt", "1day", 10))
...
if __name__ == '__main__':
    ...
    #get_raw_price_data()
    print(get_current_kline(currency_type = 'btc', to_another = "usdt", period = '1day', depth = 2))
    #print("create order")
