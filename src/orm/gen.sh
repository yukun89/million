...
sqlacodegen --tables block_info,cme_info,coin_list,coin_markets,daily_greedy_fear_index,test_orm,kline,exchange_info,bitfinex_info --outfile=./Schema.py mysql+pymysql://rw_user_huangyukun:'2022CpHykMillion.'@10.0.0.11:3306/million?charset=utf8;
